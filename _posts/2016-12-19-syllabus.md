...
|Wednesday, January 18 | We will continue with ligand-reception binding and talk about the MWC model of allostery. We will then move on to genetic switches as well as talk about how to "build a fly." Next we consider how you shape a cell? We'll cover cell organization including cytoskeletal assemblies, membranes, and phase transitions. How do you build an organism? We’ll wrap up with a discussion of how tissues and even entire body plans develop from a quantitative point of view.|
